...
#define OSTREE_BOOTLOADER_SD_BOOT(inst) \
  (G_TYPE_CHECK_INSTANCE_CAST ((inst), OSTREE_TYPE_BOOTLOADER_SD_BOOT, OstreeBootloaderSdBoot))
#define OSTREE_IS_BOOTLOADER_SD_BOOT(inst) \
  (G_TYPE_CHECK_INSTANCE_TYPE ((inst), OSTREE_TYPE_BOOTLOADER_SD_BOOT))
